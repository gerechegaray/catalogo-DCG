...
describe('AuthContext Working Tests', () => {
  beforeEach(() => {
  ...
  describe('Admin Authentication', () => {
    it('autentica admin con código correcto', async () => {
      render(
        <TestWrapper>
          <TestAuthComponent />
        </TestWrapper>
    ...
    it('mantiene autenticación admin en localStorage', async () => {
    ...
    it('cierra sesión admin correctamente', async () => {
      // Autenticar primero
      localStorage.setItem('admin_authenticated', 'true')
  ...
  describe('Access Control', () => {
    it('permite acceso a rutas públicas', async () => {
    ...
    it('solo permite acceso a admin en ruta /admin', async () => {
      const TestAccessComponent = () => {
        const auth = useAuth()
        return (
  ...
  describe('Product Filtering', () => {
    it('filtra productos correctamente para admin', async () => {
    ...
    it('filtra productos correctamente para usuario público', async () => {
      const TestFilterComponent = () => {
        const auth = useAuth()
        const mockProducts = [
          { id: '1', name: 'Producto 1', priceLists: [{ name: 'General', price: 100 }] },
